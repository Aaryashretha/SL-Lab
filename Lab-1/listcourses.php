    ...
    <table width="100%" border="1">
        ...
        <?php foreach ($records as $key => $record) { ?>
            ...
            <td><?php echo $record['updated_at']; ?></td>
                <td>
                    <a href="editcourses.php?edtid=<?php echo $record['id'] ?>" onclick="return confirm('Are you sure to edit?')">Edit</a>
                    <a href="listcourses.php?delid=<?php echo $record['id'] ?>" onclick="return confirm('Are you sure to delete?')">Delete</a>
                </td>
            </tr>
        <?php } ?>
    </table>
